export default function Custom404(second){
        ...
        <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8">
            <div className="max-w-lg mx-auto flex-1 flex-row-reverse gap-12 items-center justify-between md:max-w-none md:flex">
                ...
                <div className="mt-12 flex-1 max-w-lg space-y-3 md:mt-0">
                    ...
                    <a href="/" className="text-red-600 duration-150 hover:text-red-400 font-medium inline-flex items-center gap-x-1">
                        Go back
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="rgb(220 38 38)" className="w-5 h-5">
